...
public class MouseInfo 
{
    ...
    /// <summary>
    /// Gets the difference in mouse cursos position betweem the previous and current frame.
    /// </summary>
    ...
    /// <summary>
    /// Returns a value that indicates whether the specified mouse button was just releases on the current frame.
    /// </summary>
    /// <param name="button">The mouse button to check.</param>
