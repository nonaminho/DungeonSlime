...
public class GamePadInfo
{
    ...
    /// <summary>
    /// Gets the previous state of the gamepad
    /// </summary>
    public GamePadState PreviousState { get; private set; }
    /// <summary>
    /// Gets a value that indicates if the gamepad is currently connected.
    /// </summary>
    ...
    /// <summary>
    /// Sets the vibrations for all motors of this gamepad
    /// </summary>
    /// <param name="strength">The strenght of the vibration from 0.0f to 1.0f </param>
